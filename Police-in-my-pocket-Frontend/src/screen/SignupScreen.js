...
import {Platform, View, StyleSheet, TextInput, SafeAreaView, TouchableOpacity, Text, Component, Image} from 'react-native';
  ...
  return (
    ...
    <View>
      <RadioForm
        ...
        labelStyle={{fontSize: 15, fontFamily: 'GmarketSansTTFMedium', marginLeft: 30}}
        disable={true}
        formHorizontal={true}
      />
      </View>
